...
本目录把 [04 执行单](../04-B路任务执行单.md) 的 P0–P5 拆成 **22 张可独立派发的任务卡**，另有 **3 张 A 路 / 核心卡**（A0、A-T9、S-N04，2026-09-26 补充）。执行单负责总览、缺口事实（G1–G6）和决策记录；任务卡是给执行 Agent 的操作输入。
...
| P1 | [B1-1](B1-1.md) | 用户动作与状态表 | 设计 | G0 | U09–U11 | 待领取 |
...
| 卡号 | 名称 | 类型 | 依赖 | 覆盖 | 状态 |
| --- | --- | --- | --- | --- | --- |
| [A0](A0.md) | flow-quality T1–T8 交付与验收 | 交付+验收 | — | AC-01…AC-16 | 进行中（T1–T7 已本地提交 `140ff9f`，未推送；T8 在做） |
| [A-T9](A-T9.md) | Codex Skill 注册、回滚、旧布局迁移（隔离 HOME） | 核心 | A0 | AC-18 | 待领取 |

...
本目录把 [04 执行单](../04-B路任务执行单.md) 的 P0–P5 拆成 **22 张可独立派发的任务卡**。执行单负责总览、缺口事实（G1–G6）和决策记录；任务卡是给执行 Agent 的操作输入。
...
| --- | --- | --- | --- | --- | --- | --- |
| P0 | [B0-1](B0-1.md) | 旧 UI 浏览器基线复核 | 调研 | — | 全部（基线） | 待领取 |
| P0 | [B0-2](B0-2.md) | 宿主交接验证 | 调研+实测 | — | U04、U05 | 有条件通过 |
| P0 | [B0-3](B0-3.md) | 接口映射与共享接口草案 | 调研 | — | 全部 | 待领取 |
| P0 | — | **G0 决策：交接主路径** | 决策 | B0-1/2/3 | — | 待定 |

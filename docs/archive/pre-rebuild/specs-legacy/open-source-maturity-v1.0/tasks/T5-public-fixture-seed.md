...
```bash
rg -n "Users/|home/|/private|placeholder|真实客户|客户名称|售前|internal agent|agent_dispatch" examples/briefs examples/preview-run README.md docs/quick-start.md docs/known-limitations.md

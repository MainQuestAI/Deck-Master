...
定向回归覆盖短稿、不同任务结构、无库路径、嵌套正文、图示关系、合法业务词、局部修改、增删页、重排、旧 run、当前 gate 和批准状态。最终还需完成完整测试、schema/静态检查、release smoke、无 Library 候选安装、真实 PPT 渲染和读回。安装完成后由用户验收专业内容、视觉表达及办公软件中的实际编辑体验。

...
2. 做一个 Web UI，能读取 manifest 并显示页面队列
3. 支持软链接资源目录 `links/`
4. 支持页面级状态和备注回写
5. 支持组装计划生成 run 目录
6. 支持导出审批后的页面队列
...
1. 接入 PPT Library 搜索结果
2. 接入 PPT Deck Pro Max 新生成页面
3. 把审批后的页面队列交给 PPTX 生成或人工组装步骤

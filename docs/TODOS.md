...
- **Context:** vNext 已在 `codex/web-preview-ui` 分支落地：`scripts/deck_master.py autoplan` 可以从用户 brief 创建 run，生成 `request.json`、`narrative_plan.json`、`library_results/selection.json`、`sourcing_plan.json`、`generation_tasks/index.json` 和 `preview_manifest.json`。详见 `docs/2026-06-06-demand-to-preview-autoplan.md`。
...
- **Context:** Preview UI 已支持展示来源决策、决策理由、候选页、风险标记和生成任务，同时保留原有页面预览、状态/备注回写和 sample run。详见 `docs/2026-05-28-deck-master-web-preview-ui.md`、`docs/2026-06-01-web-preview-ui-implementation-plan.md` 与 `docs/2026-06-06-demand-to-preview-autoplan.md`。

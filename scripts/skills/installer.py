...
SUITE_SKILLS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "required": False,
        "role": "build_profile",
        "public_name": "deck-builder-high-density",
        "compat_aliases": [],
        "input_types": ["page_packages", "content_lock", "blueprint", "page_scene"],
        "exit_artifacts": ["high_density_manifest", "deck_pptx", "artifact_manifest", "render_result.v2"],
        "backend_dependency": "",
        "required_for": ["high_density"],
        "install_source": "bundled",
        "cli": "deck-master",
...
def product_capability_manifest() -> dict[str, Any]:
    ...
    return {
        ...
        "optional_capabilities": ["deck-learn", "deck-builder-high-density"],
        "core_skills": core,
        "public_skills": core,
